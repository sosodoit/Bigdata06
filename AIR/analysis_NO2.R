...
=======
>>>>>>> 6626aded5a331984955897416e0f8b66e2ce6629
#******************************************************************************#
#                         구별로 대기오염물질 no2 분석
#                          --> 39(측정소)*no2
#******************************************************************************#
...
sgg_lst.te <- list(sgg1.te, sgg2.te, sgg3.te, sgg4.te, sgg5.te, 
                   sgg6.te, sgg7.te, sgg8.te, sgg9, sgg10.te,
                   sgg11.te, sgg12.te, sgg13.te, sgg14.te, sgg15.te,
                   sgg16.te, sgg17.te, sgg18.te, sgg19.te, sgg20.te,
                   sgg21.te, sgg22.te, sgg23.te, sgg24.te, sgg25.te, 
                   sgg26.te, sgg27.te, sgg28.te, sgg29.te, sgg30.te,
                   sgg31.te, sgg32.te, sgg33.te, sgg34.te, sgg35.te, 
                   sgg36.te, sgg37.te, sgg38.te, sgg39.te)

for (i in 1:length(kind_ssg)){
  area <- paste0("sgg",as.character(i))
  #area.te <- paste0("sgg",as.character(i),".te") # 이걸로 할 수 있을 거같아서 잠시만 냅둠.
...
forecasts <- lapply(mod_lst, forecast, h=52) 
#1)12 ->12개추정 같은데 데이터가 10개월만 있어서 월의 평균으로 10개씩 나오는 거 같음
#2)주단위데이터니까 52주고 1년예측하고 싶어서 h=52*1
forecasts$naive <- naive(train.no2.ts, 52)
