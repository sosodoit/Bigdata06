...
f.o3(sgg1, sgg1.te)
save.image(file = "./data/analysis_O3_sgg1.RData")
f.o3(sgg10, sgg10.te) # 구로구
save.image(file = "./data/analysis_O3_sgg10.RData")
f.o3(sgg30, sgg30.te) # 정릉로
save.image(file = "./data/analysis_O3_sgg30.RData")
...
# melt_data <- melt(train.gangnam, id.vars = c("o3", "O3","CO","SO2","o3"))
# 
